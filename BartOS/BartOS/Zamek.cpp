...
void Zamek::lock(int ID_procesu)
{
	...
	{
		cout << "Zamek: Zmieniam stan procesu " <<ID_procesu<< " na oczekujacy"<<endl; // zmieniam stan w¹tku na waiting
...
void Zamek::unlock(int ID_procesu)
{
	if (this->ID_procesu == ID_procesu)
	{
		...
		{	
			cout << "Zamek: Zmieniam stan procesu "<<ID_procesu<<" na gotowy"<<endl; //zmieniam stan w¹tku na ready
